...
public class RestaurantsActivity extends AppCompatActivity implements MyListFragment.ListSelectionListener {

    public static String[] myRestaurantsArray;
    public static String[] myRestaurantsWebsiteArray;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("WHICHACTIVITY", "ONRESTAURANT");

        // Get string arrays for list and website
        myRestaurantsArray = getResources().getStringArray(R.array.restaurantsArray);
        myRestaurantsWebsiteArray = getResources().getStringArray(R.array.restaurantsWebsiteArray);

        myBrowserFragment = new MyBrowserFragment();
        fragmentBundle = new Bundle();
        fragmentBundle.putString("Website", "RestaurantsWebsite");
        ...
        fragmentBundle.putString("List", "RestaurantsList");
